        ...
        ClassVisitor cv = new ClassVisitor(ASM4, cw) {
            ...
            public MethodVisitor visitMethod(int access, String methodName, String desc, String signature, String[] exceptions) {
                ...
                if (s1.equals("onUpdate") || s1.equals(TakumiASMNameMap.METHOD_MAP.get("onUpdate"))
                        || methodName.equals("onUpdate") || methodName.equals(TakumiASMNameMap.METHOD_MAP.get("onUpdate"))) {
                    ...
                    mv = new MethodVisitor(ASM4, mv) {
                        ...
                        public void visitMethodInsn(int opcode, String owner, String methodName, String desc, boolean itf) {
                            ...
                            if (s2.equals("explode") || s2.equals(TakumiASMNameMap.METHOD_MAP.get("explode"))
                                    || methodName.equals("explode") || methodName.equals(TakumiASMNameMap.METHOD_MAP.get("explode"))) {
