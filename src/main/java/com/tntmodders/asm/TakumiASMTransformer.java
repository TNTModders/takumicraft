    ...
    private byte[] transformEntityCreeper(String name, String transformedName, byte... bytes) {
        ...
        ClassVisitor cv = new ClassVisitor(ASM4, cw) {
            ...
            public MethodVisitor visitMethod(int access, String methodName, String desc, String signature, String[] exceptions) {
                ...
                if (s1.equals("onUpdate") || s1.equals(TakumiASMNameMap.METHOD_MAP.get("onUpdate")) || methodName.equals("onUpdate") || methodName
                        .equals(TakumiASMNameMap.METHOD_MAP.get("onUpdate"))) {
                    ...
                    mv = new MethodVisitor(ASM4, mv) {
                        ...
                        public void visitMethodInsn(int opcode, String owner, String methodName, String desc, boolean itf) {
                            ...
                            if (s2.equals("explode") || s2.equals(TakumiASMNameMap.METHOD_MAP.get("explode")) || methodName.equals("explode") ||
                                    methodName.equals(TakumiASMNameMap.METHOD_MAP.get("explode"))) {
                                //引数として次に渡す値にthisを指定する。
                                mv.visitVarInsn(ALOAD, 0);
                                //メソッドを読み込む。INVOKESTATICでstaticメソッドを呼び出す。
                                super.visitMethodInsn(INVOKESTATIC, "com/tntmodders/asm/TakumiASMHooks", "TakumiExplodeHook", Type
                                        .getMethodDescriptor(Type.VOID_TYPE, Type.getObjectType("net/minecraft/entity/monster/EntityCreeper")),
                                        false);
    ...
    private byte[] transformTileEntityRenderer(String name, String transformedName, byte[] bytes) {
        ClassReader cr = new ClassReader(bytes); ClassWriter cw = new ClassWriter(1); ClassVisitor cv = new ClassVisitor(ASM4, cw) {
            ...
            public MethodVisitor visitMethod(int access, String methodName, String desc, String signature, String[] exceptions) {
                ...
                //C:\Users\<ユーザー名>\.gradle\caches\minecraft\net\minecraftforge\forge\1.7.10-10.13.4.1558-1.7.10\forge-1.7.10-10.13.4.1558-1.7.10
                // -decomp.jar\より名称を検索、比較してメソッドの難読化名を探す。
                if (s1.equals("renderByItem") || s1.equals(TakumiASMNameMap.METHOD_MAP.get("renderByItem")) || methodName.equals("renderByItem") ||
                    ...
                    mv = new MethodVisitor(ASM4, mv) {
                        ...
                        public void visitMethodInsn(int opcode, String owner, String methodName, String desc, boolean itf) {
                            ...
                            if (s2.equals("renderByItem") || s2.equals(TakumiASMNameMap.METHOD_MAP.get("renderByItem2")) || methodName.equals
                                ...
                                //メソッドを読み込む。INVOKESTATICでstaticメソッドを呼び出す。
                                super.visitMethodInsn(INVOKESTATIC, "com/tntmodders/asm/TakumiASMHooks", "TakumiRenderByItemHook", Type
                                        .getMethodDescriptor(Type.VOID_TYPE, Type.getObjectType("net/minecraft/item/ItemStack")), false);
                                //今回はフックを差し込むだけだが、ここで書き換えも出来る。
                            }
                            //今回は最後に元のクラスを読み込んでreturnする。
                            super.visitMethodInsn(opcode, owner, methodName, desc, itf);
