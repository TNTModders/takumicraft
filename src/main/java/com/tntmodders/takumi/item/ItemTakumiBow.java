            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if ((double) f >= 0.1D) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        entityarrow.setAim(entityplayer, entityplayer.rotationPitch, entityplayer.rotationYaw, 0.0F, f * 4.5F, 1.5F);

                        if (f == 1.0F) {
                            entityarrow.setIsCritical(true);
                        }

                        int j = EnchantmentHelper.getEnchantmentLevel(Enchantments.POWER, stack) + 1;
