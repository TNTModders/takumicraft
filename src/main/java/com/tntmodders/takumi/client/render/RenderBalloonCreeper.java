...
public class RenderBalloonCreeper<T extends EntityBalloonCreeper> extends RenderLiving<T> implements ITakumiRender {

    private static final ResourceLocation GHAST_TEXTURES =
            new ResourceLocation(TakumiCraftCore.MODID, "textures/entity/ballooncreeper.png");
    private static final ResourceLocation GHAST_SHOOTING_TEXTURES =
            new ResourceLocation(TakumiCraftCore.MODID, "textures/entity/ballooncreeper_shooting.png");

    public RenderBalloonCreeper(RenderManager renderManagerIn) {
