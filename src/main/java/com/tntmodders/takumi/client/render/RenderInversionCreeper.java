...
public class RenderInversionCreeper <T extends EntityTakumiAbstractCreeper> extends RenderLiving <T> {
    ...
    public RenderInversionCreeper(RenderManager renderManagerIn, ModelBase model) {
        super(renderManagerIn, model, 0.5F); this.addLayer(new LayerTakumiCharge(this));
    }
    ...
    protected void preRenderCallback(T entitylivingbaseIn, float partialTickTime) {
        GlStateManager.rotate(180, 1, 0, 0); GlStateManager.translate(0, 1.65, 0); if (entitylivingbaseIn.getSizeAmp() != 1) {
            double d = entitylivingbaseIn.getSizeAmp(); GlStateManager.scale(d, d, d);
