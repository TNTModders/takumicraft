...
public class RenderTakumiItemFrame extends RenderItemFrame {
    private static final ResourceLocation MAP_BACKGROUND_TEXTURES = new ResourceLocation("textures/map/map_background.png");
    private final Minecraft mc = Minecraft.getMinecraft();
    private final ModelResourceLocation itemFrameModel = new ModelResourceLocation("item_frame", "normal");
    private final ModelResourceLocation mapModel = new ModelResourceLocation("item_frame", "map");

    private final ModelResourceLocation takumi_itemFrameModel = new ModelResourceLocation("takumicraft:creeperframe","normal");
    private final ModelResourceLocation takumi_mapModel = new ModelResourceLocation("takumicraft:creeperframe", "map");
    private final RenderItem itemRenderer;

    public RenderTakumiItemFrame(RenderManager renderManagerIn, RenderItem itemRendererIn) {
    ...
    public void doRender(EntityItemFrame entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (ItemTakumiItemFrame.isItemFrameAntiExplosion(entity)) {
            if (entity.getDisplayedItem().getItem() instanceof net.minecraft.item.ItemMap) {
                ibakedmodel = modelmanager.getModel(this.takumi_mapModel);
            } else {
                ibakedmodel = modelmanager.getModel(this.takumi_itemFrameModel);
            }
        } else {
            if (entity.getDisplayedItem().getItem() instanceof net.minecraft.item.ItemMap) {
