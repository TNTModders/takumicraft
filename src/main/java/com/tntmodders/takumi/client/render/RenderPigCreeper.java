...
import com.tntmodders.takumi.entity.mobs.EntityPigCreeper;
...
public class RenderPigCreeper<T extends EntityPigCreeper> extends RenderLiving<T> implements ITakumiRender {

    public RenderPigCreeper(RenderManager renderManagerIn) {
