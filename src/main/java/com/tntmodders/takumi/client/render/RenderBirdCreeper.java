...
import com.tntmodders.takumi.entity.mobs.EntityBirdCreeper;
...
public class RenderBirdCreeper <T extends EntityBirdCreeper> extends RenderLiving <T> implements ITakumiRender {
    
    public RenderBirdCreeper(RenderManager renderManagerIn) {
