...
public class RenderBoneDummy extends RenderLivingBase<EntityBoneDummy> {

    public RenderBoneDummy(RenderManager renderManager) {
        this(renderManager, false);
    }

    public RenderBoneDummy(RenderManager renderManager, boolean useSmallArms) {
    ...
    @Override
    protected int getColorMultiplier(EntityBoneDummy entitylivingbaseIn, float lightBrightness, float partialTickTime) {
     ...
     */
    @Override
    public void doRender(EntityBoneDummy entitydummy, double x, double y, double z, float entityYaw,
            float partialTicks) {
...
/*                if (entity.isSneaking()) {
    ...
    private void setModelVisibilities(EntityBoneDummy clientPlayerdummy) {
     ...
     */
    @Override
    public ResourceLocation getEntityTexture(EntityBoneDummy entity) {
     ...
     */
    @Override
    protected void preRenderCallback(EntityBoneDummy entitylivingbaseIn, float partialTickTime) {
    ...
    @Override
    protected void renderEntityName(EntityBoneDummy entity, double x, double y, double z, String name,
            double distanceSq) {
    ...
    public void renderRightArm(EntityBoneDummy clientPlayer) {
        float f = 1.0F;
    ...
    public void renderLeftArm(EntityBoneDummy clientPlayer) {
        float f = 1.0F;
        GlStateManager.color(1.0F, 1.0F, 1.0F);
        float f1 = 0.0625F;
        ModelPlayer modelplayer = this.getMainModel();
     ...
     */
    @Override
    protected void renderLivingAt(EntityBoneDummy entityLivingBase, double x, double y, double z) {
    ...
    @Override
    protected void applyRotations(EntityBoneDummy entityLivingIn, float p_77043_2_, float rotationYaw,
            float partialTicks) {
    ...
    @SideOnly(Side.CLIENT)
    public class LayerDeadmauHeadDummy implements LayerRenderer<EntityBoneDummy> {
        private final RenderBoneDummy playerRenderer;

        public LayerDeadmauHeadDummy(RenderBoneDummy playerRendererIn) {
            this.playerRenderer = playerRendererIn;
        }

        @Override
        public void doRenderLayer(EntityBoneDummy entitylivingbase, float limbSwing, float limbSwingAmount,
    ...
    @SideOnly(Side.CLIENT)
    public class LayerCapeDummy implements LayerRenderer<EntityBoneDummy> {
        private final RenderBoneDummy playerRenderer;

        public LayerCapeDummy(RenderBoneDummy playerRendererIn) {
            this.playerRenderer = playerRendererIn;
        }
...
/*                    if (entitylivingbaseIn.isSneaking()) {
    ...
    public class LayerCreeperChargeDummy implements LayerRenderer<EntityCreeper> {
        ...
        private final RenderBoneDummy creeperRenderer;
        private final ModelCreeper creeperModel = new ModelCreeper(2.0F);

        public LayerCreeperChargeDummy(RenderBoneDummy creeperRendererIn) {
