...
import com.tntmodders.takumi.entity.mobs.EntityEndermiteCreeper;
...
public class RenderEndermiteCreeper <T extends EntityEndermiteCreeper> extends RenderLiving <T> implements ITakumiRender {
    
    public RenderEndermiteCreeper(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelEnderMite(), 0.3f); this.addLayer(new LayerTakumiCharge(this));
    }
