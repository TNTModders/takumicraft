...
import com.tntmodders.takumi.entity.mobs.EntityCowCreeper;
...
public class RenderCowCreeper<T extends EntityCowCreeper> extends RenderLiving<T> implements ITakumiRender {

    public RenderCowCreeper(RenderManager renderManagerIn) {
