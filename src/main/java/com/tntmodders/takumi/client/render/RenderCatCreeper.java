...
import com.tntmodders.takumi.client.model.ModelCatCreeper;
...
public class RenderCatCreeper <T extends EntityCatCreeper> extends RenderLiving <T> implements ITakumiRender {
    
    public RenderCatCreeper(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelCatCreeper(), 0.5f);
