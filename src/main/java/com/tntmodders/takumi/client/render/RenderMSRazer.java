...
import com.tntmodders.takumi.entity.item.EntityMSRazer;
...
public class RenderMSRazer<T extends EntityMSRazer> extends Render<T> {
    private static final ResourceLocation LOCATION =
            new ResourceLocation(TakumiCraftCore.MODID, "textures/entity/item/msrazer.png");

    public RenderMSRazer(RenderManager renderManager) {
        super(renderManager);
    }
