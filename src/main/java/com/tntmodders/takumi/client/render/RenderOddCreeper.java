...
import com.tntmodders.takumi.entity.mobs.EntityOddCreeper;
...
public class RenderOddCreeper<T extends EntityOddCreeper> extends RenderLiving<T> {

    public RenderOddCreeper(RenderManager renderManagerIn) {
        this(renderManagerIn, new ModelCreeper());
    }

    public RenderOddCreeper(RenderManager renderManagerIn, ModelBase model) {
    ...
    private class LayerSeasonCreepers<E extends EntityTakumiAbstractCreeper> implements LayerRenderer<E> {
        ...
        final RenderOddCreeper renderTakumiCreeper;
        ...
        public LayerSeasonCreepers(RenderOddCreeper creeper) {
