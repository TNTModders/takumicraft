...
public class RenderIceologerCreeper<T extends EntityAbstractSpellCreeper> extends RenderLiving<T> implements ITakumiRender {

    public RenderIceologerCreeper(RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelIllagerCreeper(0.0F, 0.0F, 96, 64), 0.5f);
        ...
        ((ModelIllagerCreeper) this.getMainModel()).cape.showModel = true;
    }
