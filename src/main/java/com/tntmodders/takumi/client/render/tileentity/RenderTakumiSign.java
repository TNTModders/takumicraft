...
public class RenderTakumiSign extends TileEntitySignRenderer {
    private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation(TakumiCraftCore.MODID, "textures/entity/creepersign.png");
    /**
     * The ModelSign instance for use in this renderer
     */
    private final ModelSign model = new ModelSign();

    public RenderTakumiSign() {
        super();
    }
    ...
    public void render(TileEntitySign te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (block == TakumiBlockCore.CREEPER_SIGN_STANDING) {
