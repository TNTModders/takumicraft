...
import com.tntmodders.takumi.entity.mobs.EntitySnowCreeper;
...
public class RenderSnowCreeper<T extends EntitySnowCreeper> extends RenderLiving<T> implements ITakumiRender {
    public RenderSnowCreeper(RenderManager renderManagerIn) {
