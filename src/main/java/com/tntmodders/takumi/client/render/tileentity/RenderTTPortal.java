...
public class RenderTTPortal<T extends TileEntityTTPortal> extends TileEntitySpecialRenderer<T> {
    private static final ResourceLocation END_SKY_TEXTURE = new ResourceLocation(TakumiCraftCore.MODID,"textures/environment/tt_sky.png");
    private static final ResourceLocation END_PORTAL_TEXTURE = new ResourceLocation(TakumiCraftCore.MODID,"textures/blocks/tt_portal.png");
    ...
    @Override
    public void render(TileEntityTTPortal te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
