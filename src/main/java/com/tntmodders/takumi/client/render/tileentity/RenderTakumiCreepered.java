...
public class RenderTakumiCreepered<T extends TileEntityTakumiCreepered> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(T te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        float f = te.getCreeperFlashIntensity(partialTicks);
        ...
        this.setBrightness(te, partialTicks);
        IBlockState state = te.getBlock() != null ? te.getBlock().getStateFromMeta(te.getMeta()) : null;
