...
public class LayerSheepCreeperWool implements LayerRenderer <EntitySheepCreeper> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(TakumiCraftCore.MODID, "textures/entity/sheepcreeper_fur.png");
    ...
    @Override
    public void doRenderLayer(EntitySheepCreeper entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks,
        ...
        if (!entitylivingbaseIn.getSheared() && !entitylivingbaseIn.isInvisible()) {
            ...
            if (entitylivingbaseIn.getRainbow()) {
                ...
                GlStateManager.color(afloat1[0] * (1.0F - f) + afloat2[0] * f, afloat1[1] * (1.0F - f) + afloat2[1] * f, afloat1[2] * (1.0F - f) +
                        afloat2[2] * f);
            } else {
