...
import com.tntmodders.takumi.entity.mobs.EntityBlazeCreeper;
...
public class RenderBlazeCreeper <T extends EntityBlazeCreeper> extends RenderLiving <T> implements ITakumiRender {
    
    public RenderBlazeCreeper(RenderManager renderManagerIn) {
