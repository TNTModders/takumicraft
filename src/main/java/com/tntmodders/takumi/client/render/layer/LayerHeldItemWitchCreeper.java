...
public class LayerHeldItemWitchCreeper implements LayerRenderer<EntityWitchCreeper> {
    ...
    @Override
    public void doRenderLayer(EntityWitchCreeper entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
