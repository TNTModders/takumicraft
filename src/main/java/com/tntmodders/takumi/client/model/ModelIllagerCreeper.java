...
import com.tntmodders.takumi.entity.mobs.EntityAbstractIllagerCreeper;
import com.tntmodders.takumi.entity.mobs.EntityAbstractIllagerCreeper.IllagerArmPose;
...
public class ModelIllagerCreeper extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor,
        ...
        } else if (abstractillager$illagerarmpose == IllagerArmPose.SPELLCASTING) {
        ...
        } else if (abstractillager$illagerarmpose == IllagerArmPose.BOW_AND_ARROW) {
