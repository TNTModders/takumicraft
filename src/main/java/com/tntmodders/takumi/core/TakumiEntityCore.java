...
public class TakumiEntityCore {
    ...
    public static final EnumCreatureType CREATURE_TAKUMI = EnumHelper.addCreatureType("creature_takumi", IMob.class, TakumiConfigCore
            .spawnWeightAnimal, Material.AIR, false, false);
    ...
    static {
        CLASS_LIST.addAll(Arrays.asList(EntityAcidCreeper.class, EntityAnnivCreeper.class, EntityAntinomyCreeper.class, EntityArrowCreeper.class,
                ...
                EntityStraightCreeper.class, EntityCrossCreeper.class, EntityTransCreeper.class,EntityShootingCreeper.class));
    }
    ...
    private static void renderRegister() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityTakumiChocolateBall.class, manager -> new RenderSnowball <>(manager, TakumiItemCore
                .TAKUMI_CHOCO_BALL, Minecraft.getMinecraft().getRenderItem()));
    }
