...
public class TakumiConfigCore {
    ...
    public static void syncConfig() {
        ...
        isTransparentCeruleanCreeper = cfg.getBoolean("isTransparentCeruleanCreeper", GENERAL, isTransparentCeruleanCreeper,
                TakumiUtils.takumiTranslate("config.takumicraft.cerulean.desc"), "config.takumicraft.cerulean.prop");
        // Difficulty
        //amountSmelting = (byte) cfg.getInt("amountSmelting", HOGE, amountSmelting, 1, Byte.MAX_VALUE, "Smelting amount of Aluminium Ingot from Aluminium Ore.", "config.aluminium.prop.amountSmelting");
        // 設定内容をコンフィグファイルに保存する。
        cfg.save();
    }
}