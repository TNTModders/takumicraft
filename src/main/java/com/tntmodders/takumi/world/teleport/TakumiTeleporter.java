...
public class TakumiTeleporter extends Teleporter {
            ...
            for (int j1 = -2; j1 <= 2; ++j1) {
                for (int k1 = -2; k1 <= 2; ++k1) {
                    for (int l1 = -1; l1 < 3; ++l1) {
                        ...
                        int k2 = k + k1 * 0 - j1 * 1;
                        boolean flag = l1 < 0;
                        this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? TakumiBlockCore.TAKUMI_PORTAL_FRAME.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
        ...
        if (this.destinationCoordinateCache.containsKey(l)) {
            TakumiTeleporter.PortalPosition teleporter$portalposition = this.destinationCoordinateCache.get(l);
            d0 = 0.0D;
        ...
        if (d0 >= 0.0D) {
            if (flag) {
                this.destinationCoordinateCache.put(l, new TakumiTeleporter.PortalPosition(blockpos, this.world.getTotalWorldTime()));
            }

            double d5 = (double) blockpos.getX() + 0.5D;
            double d7 = (double) blockpos.getZ() + 0.5D;
            BlockPattern.PatternHelper blockpattern$patternhelper = TakumiBlockCore.TAKUMI_PORTAL.createPatternHelper(this.world, blockpos);
            ...
            //TakumiCraftCore.LOGGER.info(entityIn.getLastPortalVec());
            ...
            for (int j7 = -1; j7 <= 1; ++j7) {
                for (int l7 = 1; l7 < 3; ++l7) {
                    for (int k8 = -1; k8 < 3; ++k8) {
                        ...
                        boolean flag = k8 < 0;
                        this.world.setBlockState(new BlockPos(k9, k10, k11), flag ? TakumiBlockCore.TAKUMI_PORTAL_FRAME.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
        }

        IBlockState iblockstate = TakumiBlockCore.TAKUMI_PORTAL.getDefaultState().withProperty(BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
        ...
        for (int i8 = 0; i8 < 4; ++i8) {
            for (int l8 = 0; l8 < 4; ++l8) {
                for (int l9 = -1; l9 < 4; ++l9) {
                    ...
                    this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? TakumiBlockCore.TAKUMI_PORTAL_FRAME.getDefaultState() : iblockstate, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long worldTime) {
        if (worldTime % 100L == 0L) {
            ...
            while (objectiterator.hasNext()) {
                TakumiTeleporter.PortalPosition teleporter$portalposition = objectiterator.next();
