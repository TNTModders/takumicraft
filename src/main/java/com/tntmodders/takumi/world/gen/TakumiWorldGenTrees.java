...
public class TakumiWorldGenTrees extends WorldGenAbstractTree {
    
    private final IBlockState log;
    private final IBlockState leaf;
    private final boolean useExtraRandomHeight;
    
    public TakumiWorldGenTrees(boolean notify, boolean useExtraRandomHeightIn, IBlockState log, IBlockState leaf) {
        super(notify);
