...
public class TakumiMapGenCaves extends MapGenBase {
    ...
    protected void addRoom(long p_180703_1_, int p_180703_3_, int p_180703_4_, ChunkPrimer p_180703_5_, double p_180703_6_, double p_180703_8_,
            double p_180703_10_) {
        this.addTunnel(p_180703_1_, p_180703_3_, p_180703_4_, p_180703_5_, p_180703_6_, p_180703_8_, p_180703_10_, 1.0F + this.rand.nextFloat() *
    ...
    protected void addTunnel(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_,
            double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double
            p_180702_17_) {
        ...
        for (boolean flag = random.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
            ...
            if (!flag2 && p_180702_15_ == j && p_180702_12_ > 1.0F && p_180702_16_ > 0) {
                this.addTunnel(random.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, random.nextFloat()
                        * 0.5F + 0.5F, p_180702_13_ - (float) Math.PI / 2F, p_180702_14_ / 3.0F, p_180702_15_, p_180702_16_, 1.0D);
                this.addTunnel(random.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, random.nextFloat()
                        * 0.5F + 0.5F, p_180702_13_ + (float) Math.PI / 2F, p_180702_14_ / 3.0F, p_180702_15_, p_180702_16_, 1.0D);
                return;
            }
    ...
    protected boolean canReplaceBlock(IBlockState p_175793_1_, IBlockState p_175793_2_) {
        return p_175793_1_.getBlock() == TakumiWorldChunkGenerator.STONE.getBlock() || p_175793_1_.getBlock() == TakumiWorldChunkGenerator.GRASS
                .getBlock() || p_175793_1_.getBlock() == TakumiWorldChunkGenerator.DIRT.getBlock() || p_175793_1_.getBlock() == Blocks.STONE ||
                p_175793_1_.getBlock() == Blocks.DIRT || p_175793_1_.getBlock() == Blocks.GRASS || p_175793_1_.getBlock() == Blocks.HARDENED_CLAY
                || p_175793_1_.getBlock() == Blocks.STAINED_HARDENED_CLAY || p_175793_1_.getBlock() == Blocks.SANDSTONE || p_175793_1_.getBlock()
                == Blocks.RED_SANDSTONE || p_175793_1_.getBlock() == Blocks.MYCELIUM || p_175793_1_.getBlock() == Blocks.SNOW_LAYER || (p_175793_1_
                .getBlock() == Blocks.SAND || p_175793_1_.getBlock() == Blocks.GRAVEL) && p_175793_2_.getMaterial() != Material.WATER &&
                p_175793_2_.getMaterial() != TakumiMaterial.HOT_SPRING && p_175793_2_.getMaterial() != TakumiMaterial.TAKUMI_WATER;
    }
