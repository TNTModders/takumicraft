...
public class TakumiWorldChunkGenerator implements IChunkGenerator {
    ...
    public TakumiWorldChunkGenerator(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
        ...
        ContextOverworld ctx = new ContextOverworld(minLimitPerlinNoise, maxLimitPerlinNoise, mainPerlinNoise, surfaceNoise, scaleNoise,
    ...
    private void generateHeightmap(int p_185978_1_, int p_185978_2_, int p_185978_3_) {
        ...
        this.maxLimitRegion = this.maxLimitPerlinNoise.generateNoiseOctaves(this.maxLimitRegion, p_185978_1_, p_185978_2_, p_185978_3_, 5, 33, 5,
                (double) f, (double) f1, (double) f);
        int i = 0;
        int j = 0;
