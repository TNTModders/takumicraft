...
public class TakumiWorldChunkGenerator implements IChunkGenerator {
    ...
    public TakumiWorldChunkGenerator(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
        {
        ...
        ContextOverworld ctx =
                new ContextOverworld(minLimitPerlinNoise, maxLimitPerlinNoise, mainPerlinNoise, surfaceNoise,
    ...
    public Chunk generateChunk(int x, int z) {
        ...
        this.biomesForGeneration =
                this.world.getBiomeProvider().getBiomes(this.biomesForGeneration, x * 16, z * 16, 16, 16);
    ...
    public void replaceBiomeTakumiWorldChunkGenerator(int x, int z, ChunkPrimer primer, Biome... biomesIn) {
                ...
                for (int j1 = -2; j1 <= 2; ++j1) {
                    for (int k1 = -2; k1 <= 2; ++k1) {
                        ...
                        float f5 = this.settings.biomeDepthOffSet +
                                biome1.getBaseHeight() * this.settings.biomeDepthWeight * 1.25f;
                        float f6 = this.settings.biomeScaleOffset +
                                biome1.getHeightVariation() * this.settings.biomeScaleWeight * 1.25f;
    ...
    public void populate(int x, int z) {
        ...
        if (biome == TakumiBiomeCore.TAKUMI_HOTSPRING_MOUNTAINS || biome == TakumiBiomeCore.TAKUMI_LAVA_MOUNTAINS) {
            Block block =
                    biome == TakumiBiomeCore.TAKUMI_HOTSPRING_MOUNTAINS ? TakumiBlockCore.HOT_SPRING : LAVA.getBlock();
        ...
        } else if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && this.settings.useWaterLakes && !flag &&
        ...
        if (!flag && this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes) {
            if (TerrainGen.populate(this, this.world, this.rand, x, z, flag, EventType.LAVA)) {
