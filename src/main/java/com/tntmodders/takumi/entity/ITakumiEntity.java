...
public interface ITakumiEntity {
    ...
    enum EnumTakumiRank {
        LOW(1, 5, 10, 50), MID(2, 10, 50, 25), HIGH(3, 100, 250, 0), BOSS(4, 500, 500, 0), TAKUMI(0, 0, 0, 0);
    ...
    enum EnumTakumiType {
        ...
        WATER_MD(3, true, true), DRAGON_MD(7, true, true), NORMAL_MD(6, true, true), CERULEAN(8, false, false),
