...
public class EntityAIFollowCatCreeper extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        List<EntityCatCreeper> list = this.creeper.world.getEntitiesWithinAABB(EntityCatCreeper.class, this.creeper.getEntityBoundingBox().grow(50.0D, 30.0D, 50.0D));
    ...
    public void updateTask() {
        if (this.catCreeper != null) {
            ...
            this.creeper.getNavigator().tryMoveToEntityLiving(this.catCreeper,
                    this.creeper.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.MOVEMENT_SPEED).getAttributeValue() * 5);
