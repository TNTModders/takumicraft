...
public class EntityAIAttackRangedTakumiBow<T extends EntitySkeletonCreeper> extends EntityAIBase {
    ...
    public EntityAIAttackRangedTakumiBow(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_) {
    ...
    protected boolean isBowInMainhand() {
        return !this.entity.getHeldItemMainhand().isEmpty() && this.entity.getHeldItemMainhand().getItem() == TakumiItemCore.TAKUMI_BOW;
    }
