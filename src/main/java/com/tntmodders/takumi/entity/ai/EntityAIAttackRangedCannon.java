...
public class EntityAIAttackRangedCannon<T extends EntityCannonCreeper> extends EntityAIBase {
    ...
    public EntityAIAttackRangedCannon(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_) {
        ...
        if (entitylivingbase != null) {
            ...
            }
            {
                if (!flag && this.seeTime < -60) {
                    ...
                    int i = this.entity.ticksExisted;
                    if (i % 100 == 0) {
