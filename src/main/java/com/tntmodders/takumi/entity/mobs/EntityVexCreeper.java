...
public class EntityVexCreeper extends EntityTakumiAbstractCreeper {
    ...
    protected static final DataParameter <Byte> VEX_FLAGS = EntityDataManager.createKey(EntityVexCreeper.class, DataSerializers.BYTE);
    ...
    class AIChargeAttack extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            return EntityVexCreeper.this.getAttackTarget() != null && !EntityVexCreeper.this.getMoveHelper().isUpdating() && EntityVexCreeper.this
                    .rand.nextInt(7) == 0 && EntityVexCreeper.this.getDistanceSqToEntity(EntityVexCreeper.this.getAttackTarget()) > 4.0D;
        }
        ...
        public boolean shouldContinueExecuting() {
            return EntityVexCreeper.this.getMoveHelper().isUpdating() && EntityVexCreeper.this.isCharging() && EntityVexCreeper.this
                    .getAttackTarget() != null && EntityVexCreeper.this.getAttackTarget().isEntityAlive();
        }
    ...
    class AICopyOwnerTarget extends EntityAITarget {
        ...
        @Override
        public boolean shouldExecute() {
            return EntityVexCreeper.this.owner != null && EntityVexCreeper.this.owner.getAttackTarget() != null && this.isSuitableTarget
                    (EntityVexCreeper.this.owner.getAttackTarget(), false);
        }
            ...
            if (this.action == Action.MOVE_TO) {
                ...
                if (d3 < EntityVexCreeper.this.getEntityBoundingBox().getAverageEdgeLength()) {
                    ...
                    if (EntityVexCreeper.this.getAttackTarget() == null) {
                        EntityVexCreeper.this.rotationYaw = -((float) MathHelper.atan2(EntityVexCreeper.this.motionX, EntityVexCreeper.this
                        ...
                        EntityVexCreeper.this.rotationYaw = -((float) MathHelper.atan2(d4, d5)) * (180F / (float) Math.PI);
                        EntityVexCreeper.this.renderYawOffset = EntityVexCreeper.this.rotationYaw;
                    }
                }
            }
    ...
    class AIMoveRandom extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            for (int i = 0; i < 3; ++i) {
                BlockPos blockpos1 = blockpos.add(EntityVexCreeper.this.rand.nextInt(15) - 7, EntityVexCreeper.this.rand.nextInt(11) - 5,
                        EntityVexCreeper.this.rand.nextInt(15) - 7);
                
                if (EntityVexCreeper.this.world.isAirBlock(blockpos1)) {
                    EntityVexCreeper.this.moveHelper.setMoveTo((double) blockpos1.getX() + 0.5D, (double) blockpos1.getY() + 0.5D, (double)
                            blockpos1.getZ() + 0.5D, 0.25D);
                    
                    if (EntityVexCreeper.this.getAttackTarget() == null) {
                        EntityVexCreeper.this.getLookHelper().setLookPosition((double) blockpos1.getX() + 0.5D, (double) blockpos1.getY() + 0.5D,
