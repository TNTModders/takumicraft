...
public class EntityLlamaCreeper extends EntityTakumiAbstractCreeper implements IRangedAttackMob {
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        if (i > 0) {
            ...
            if (iblockstate.getMaterial() != Material.AIR && !this.isSilent()) {
                ...
                this.world.playSound(null, this.posX, this.posY, this.posZ, soundtype.getStepSound(), this.getSoundCategory(), soundtype.getVolume
                        () * 0.5F, soundtype.getPitch() * 0.75F);
            }
        }
    }
    ...
    private void spit(EntityLivingBase target) {
        ...
        this.world.playSound(null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_LLAMA_SPIT, this.getSoundCategory(), 1.0F, 1.0F + (this.rand
                .nextFloat() - this.rand.nextFloat()) * 0.2F);
