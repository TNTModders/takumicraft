...
public class EntityZombieCreeper extends EntityTakumiAbstractCreeper {
    ...
    private static final DataParameter<Boolean> IS_CHILD =
            EntityDataManager.createKey(EntityZombieCreeper.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> VILLAGER_TYPE =
            EntityDataManager.createKey(EntityZombieCreeper.class, DataSerializers.VARINT);
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn) {
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL ||
                this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (livingdata instanceof GroupData && !(this instanceof EntityGiantCreeper)) {
            ...
            if (entityzombie$groupdata.isChild) {
                ...
                if (this.world.rand.nextFloat() < 0.05D) {
                    List<EntityChicken> list = this.world.getEntitiesWithinAABB(EntityChicken.class,
        ...
        if (this.getItemStackFromSlot(EntityEquipmentSlot.HEAD).isEmpty() &&
                this.getClass() != EntityZombieVillagerCreeper.class) {
        ...
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (entitylivingbase != null && this.world.getDifficulty() == EnumDifficulty.HARD &&
                    (double) this.rand.nextFloat() <
                            this.getEntityAttribute(SPAWN_REINFORCEMENTS_CHANCE).getAttributeValue() &&
                    ...
                    if (this.world.getBlockState(new BlockPos(i1, j1 - 1, k1)).isSideSolid(this.world,
                        ...
                        if (!this.world.isAnyPlayerWithinRangeAt(i1, j1, k1, 7.0D) &&
                            ...
                            entityzombie.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombie)),
                                    null);
                            this.getEntityAttribute(SPAWN_REINFORCEMENTS_CHANCE).applyModifier(
                                    new AttributeModifier("Zombie reinforcement caller " + "charge",
