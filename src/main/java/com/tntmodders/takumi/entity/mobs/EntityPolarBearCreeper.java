...
public class EntityPolarBearCreeper extends EntityTakumiAbstractCreeper {
    ...
    private static final DataParameter <Boolean> IS_STANDING = EntityDataManager.createKey(EntityPolarBearCreeper.class, DataSerializers.BOOLEAN);
    ...
    class AIPanic extends EntityAIPanic {
        ...
        public boolean shouldExecute() {
            return (EntityPolarBearCreeper.this.isChild() || EntityPolarBearCreeper.this.isBurning()) && super.shouldExecute();
        }
    }
}
