...
public class EntitySnowCreeper extends EntityTakumiAbstractCreeper implements IRangedAttackMob {
    ...
    public void takumiExplode() {
        if (!this.world.isRemote) {
            for (int i = 0; i < 20 * (this.getPowered() ? 1.5 : 1); i++) {
                ...
                arrow.motionZ = 0;
                arrow.motionY = -0.5;
                arrow.setThrowableHeading(arrow.motionX, arrow.motionY, arrow.motionZ, (float) (14 - this.world.getDifficulty().getDifficultyId() * 8), 1f);
    ...
    public void customSpawn() {
        EntityRegistry.addSpawn(this.getClass(), this.takumiRank().getSpawnWeight(), 1, 3, EnumCreatureType.MONSTER
                , Biomes.COLD_BEACH, Biomes.COLD_TAIGA, Biomes.COLD_TAIGA_HILLS, Biomes.MUTATED_TAIGA_COLD, Biomes.FROZEN_RIVER
                , Biomes.ICE_PLAINS, Biomes.ICE_MOUNTAINS, Biomes.MUTATED_ICE_FLATS, Biomes.EXTREME_HILLS);
    }
