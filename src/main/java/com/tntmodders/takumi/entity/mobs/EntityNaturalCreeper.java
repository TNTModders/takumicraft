    ...
    public void takumiExplode() {
        if (!this.world.isRemote) {
            ...
            WorldGenAbstractTree tree = this.getPowered() ?
                                        new TakumiWorldGenBigTree(true, TakumiBlockCore.GUNORE.getDefaultState(), TakumiBlockCore.CREEPER_BOMB
                                                .getDefaultState()) :
                                        new TakumiWorldGenTrees(true, false, TakumiBlockCore.GUNORE.getDefaultState(), TakumiBlockCore.CREEPER_BOMB
                                                .getDefaultState());
