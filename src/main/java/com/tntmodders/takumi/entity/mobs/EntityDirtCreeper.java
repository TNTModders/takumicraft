...
public class EntityDirtCreeper extends EntityTakumiAbstractCreeper {
    
    public EntityDirtCreeper(World worldIn) {
        super(worldIn);
    }
    ...
    public float getExplosionResistance(Explosion explosionIn, World worldIn, BlockPos pos, IBlockState blockStateIn) {
        ...
        return blockStateIn.getBlockHardness(worldIn, pos) == -1 || s == null || !s.equalsIgnoreCase("shovel") ? 10000000f : 2.5f;
    }
    ...
    public boolean takumiExplodeEvent(Detonate event) {
        ...
        if (power > 0.1) {
            for (BlockPos pos : event.getAffectedBlocks()) {
                ...
                if (!this.world.isRemote && s != null && s.equalsIgnoreCase("shovel") && TakumiUtils.takumiGetBlockResistance(this, this.world
