...
public class EntityWitchCreeper extends EntityTakumiAbstractCreeper implements IRangedAttackMob {
    ...
    private static final DataParameter<Boolean> IS_AGGRESSIVE =
            EntityDataManager.createKey(EntityWitchCreeper.class, DataSerializers.BOOLEAN);
        ...
        if (!this.world.isRemote) {
            if (this.isDrinkingPotion()) {
                ...
                if (potiontype != null) {
                    ...
                    this.world.playSound(null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_WITCH_DRINK,
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor) {
        if (!this.isDrinkingPotion()) {
            ...
            EntityPotion entitypotion = new EntityTakumiPotion(this.world, this,
            ...
            this.world.playSound(null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_WITCH_THROW,
                    this.getSoundCategory(), 1.0F, 0.8F + this.rand.nextFloat() * 0.4F);
