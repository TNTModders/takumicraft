...
public class EntityRabbitCreeper extends EntityTakumiAbstractCreeper {
    ...
    public float setJumpCompletion(float p_setJumpCompletion_1_) {
        return this.jumpDuration == 0 ? 0.0F :
                ((float) this.jumpTicks + p_setJumpCompletion_1_) / (float) this.jumpDuration;
    }
    ...
    public boolean attackEntityFrom(DamageSource p_attackEntityFrom_1_, float p_attackEntityFrom_2_) {
        return !this.isEntityInvulnerable(p_attackEntityFrom_1_) &&
    ...
    private boolean isRabbitBreedingItem(Item p_isRabbitBreedingItem_1_) {
        return p_isRabbitBreedingItem_1_ == Items.CARROT || p_isRabbitBreedingItem_1_ == Items.GOLDEN_CARROT ||
                p_isRabbitBreedingItem_1_ == Item.getItemFromBlock(Blocks.YELLOW_FLOWER);
    }
    ...
    protected void createEatingParticles() {
        ...
        this.world.spawnParticle(EnumParticleTypes.BLOCK_DUST,
                ...
                0.0D, Block.getStateId(lvt_2_1_));
        this.carrotTicks = 40;
    }
    ...
    private void calculateRotationYaw(double p_calculateRotationYaw_1_, double p_calculateRotationYaw_3_) {
        this.rotationYaw = (float) (
                MathHelper.atan2(p_calculateRotationYaw_3_ - this.posZ, p_calculateRotationYaw_1_ - this.posX) *
    ...
    static class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T> {
        ...
        public AIAvoidEntity(EntityRabbitCreeper p_i46403_1_, Class<T> p_i46403_2_, float p_i46403_3_,
                double p_i46403_4_, double p_i46403_6_) {
    ...
    static class RabbitMoveHelper extends EntityMoveHelper {
        ...
        @Override
        public void setMoveTo(double p_setMoveTo_1_, double p_setMoveTo_3_, double p_setMoveTo_5_,
                double p_setMoveTo_7_) {
        ...
        public void onUpdateMoveHelper() {
            if (this.rabbit.onGround && !this.rabbit.isJumping &&
                    !((RabbitJumpHelper) this.rabbit.jumpHelper).getIsJumping()) {
