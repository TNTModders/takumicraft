...
public class EntityOddDummyGhast extends EntityGhast {
    public EntityOddDummyGhast(World worldIn) {
        super(worldIn);
        this.setSize(1, 1);
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote && this.ticksExisted % 20 == 0) {
            ...
            this.world.createExplosion(this, this.posX + this.motionX * 3, this.posY + this.motionY * 3,
                    this.posZ + this.motionZ * 3, 4f, true);
        }
            ...
            if (this.action == EntityMoveHelper.Action.MOVE_TO) {
                ...
                if (this.courseChangeCooldown-- <= 0) {
                    ...
                    if (this.isNotColliding(this.posX, this.posY, this.posZ, d3)) {
                        this.parentEntity.motionX += d0 / d3 * 0.4D;
                        this.parentEntity.motionY += d1 / d3 * 0.4D;
                        this.parentEntity.motionZ += d2 / d3 * 0.4D;
                    } else {
