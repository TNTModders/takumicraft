...
public class EntityWoodCreeper extends EntityTakumiAbstractCreeper {
    ...
    public float getExplosionResistance(Explosion explosionIn, World worldIn, BlockPos pos, IBlockState blockStateIn) {
        ...
        return blockStateIn.getBlockHardness(worldIn, pos) == -1 || s == null || !s.equalsIgnoreCase("axe") ?
                10000000f : 2.5f;
    }
    ...
    public boolean takumiExplodeEvent(Detonate event) {
        ...
        if (power > 0.1) {
            for (BlockPos pos : event.getAffectedBlocks()) {
                ...
                if (!this.world.isRemote && s != null && s.equalsIgnoreCase("axe") &&
                    ...
                    TakumiUtils.takumiCreateExplosion(this.world, this, pos.getX() + 0.5, pos.getY() + 0.5,
                            pos.getZ() + 0.5, power - 0.1f, false, true);
                }
            }
        }
        return true;
