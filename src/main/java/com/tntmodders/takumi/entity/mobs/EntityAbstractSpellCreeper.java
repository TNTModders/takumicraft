...
public abstract class EntityAbstractSpellCreeper extends EntityAbstractIllagerCreeper {
    ...
    private static final DataParameter<Byte> SPELL =
            EntityDataManager.createKey(EntityAbstractSpellCreeper.class, DataSerializers.BYTE);
    ...
    public class AICastingApell extends EntityAIBase {
        ...
        public void updateTask() {
            if (EntityAbstractSpellCreeper.this.getAttackTarget() != null) {
                EntityAbstractSpellCreeper.this.getLookHelper().setLookPositionWithEntity(
                        EntityAbstractSpellCreeper.this.getAttackTarget(),
                        (float) EntityAbstractSpellCreeper.this.getHorizontalFaceSpeed(),
                        (float) EntityAbstractSpellCreeper.this.getVerticalFaceSpeed());
            }
        }
    }
    ...
    public abstract class AIUseSpell extends EntityAIBase {
        ...
        @Override
        public boolean shouldExecute() {
            return EntityAbstractSpellCreeper.this.getAttackTarget() != null &&
                    !EntityAbstractSpellCreeper.this.isSpellcasting() &&
