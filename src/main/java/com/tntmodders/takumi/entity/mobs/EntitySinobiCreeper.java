...
public class EntitySinobiCreeper extends EntityTakumiAbstractCreeper {
    ...
    private class ParticleSmokeSinobi extends ParticleSmokeNormal {
        ...
        public ParticleSmokeSinobi(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i46348_8_, double p_i46348_10_,
                double p_i46348_12_, float p_i46348_14_) {
