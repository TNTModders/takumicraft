...
public class EntityShulkerCreeper extends EntityTakumiAbstractCreeper {
    ...
    public void customSpawn() {
        EntityRegistry.addSpawn(EntityShulkerCreeper.class, this.takumiRank().getSpawnWeight(), 1, 1, EnumCreatureType.MONSTER, TakumiEntityCore
                .biomes.toArray(new Biome[0]));
        EntityRegistry.addSpawn(EntityShulkerCreeper.class, this.takumiRank().getSpawnWeight(), 5, 5, EnumCreatureType.MONSTER, Biomes.SKY);
    }
