...
public class EntityDarkCreeper extends EntityTakumiAbstractCreeper {
    ...
    private static final DataParameter<Optional<IBlockState>> CARRIED_BLOCK = EntityDataManager.createKey(EntityDarkCreeper.class, DataSerializers.OPTIONAL_BLOCK_STATE);
