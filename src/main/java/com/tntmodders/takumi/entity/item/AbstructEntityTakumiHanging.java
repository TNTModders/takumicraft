...
public abstract class AbstructEntityTakumiHanging extends EntityLivingBase {
    ...
    public AbstructEntityTakumiHanging(World worldIn) {
        super(worldIn);
        this.setSize(0.5F, 0.5F);
    }

    public AbstructEntityTakumiHanging(World worldIn, BlockPos hangingPositionIn) {
        this(worldIn);
