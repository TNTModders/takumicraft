...
public class EntityTakumiPainting extends AbstructEntityTakumiHanging {
    public EnumArt art;

    public EntityTakumiPainting(World worldIn) {
        super(worldIn);
    }

    public EntityTakumiPainting(World worldIn, BlockPos pos, EnumFacing facing) {
        super(worldIn, pos);
    ...
    public EntityTakumiPainting(World worldIn, BlockPos pos, EnumFacing facing, String title) {
