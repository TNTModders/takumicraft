...
public class BlockTakumiStandingSign extends BlockStandingSign {
    public BlockTakumiStandingSign() {
        super();
        this.setRegistryName(TakumiCraftCore.MODID, "creeperstandingsign");
        this.setUnlocalizedName("creeperstandingsign");
