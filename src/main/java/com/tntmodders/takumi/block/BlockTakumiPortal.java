...
public class BlockTakumiPortal extends BlockBreakable {
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
        ...
        return flag4 && side == EnumFacing.WEST || flag4 && side == EnumFacing.EAST || flag5 && side == EnumFacing.NORTH || flag5 && side ==
                EnumFacing.SOUTH;
    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (worldIn.provider.isSurfaceWorld() && worldIn.getGameRules().getBoolean("doMobSpawning") && rand.nextInt(2000) < worldIn.getDifficulty()
                .getDifficultyId()) {
            int i = pos.getY();
            BlockPos blockpos;
            ...
            if (i > 0 && !worldIn.getBlockState(blockpos.up()).isNormalCube()) {
                Entity entity = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.getKey(EntityCreeper.class), (double) blockpos.getX() + 0.5D,
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (rand.nextInt(100) == 0) {
            worldIn.playSound((double) pos.getX() + 0.5D, (double) pos.getY() + 0.5D, (double) pos.getZ() + 0.5D, SoundEvents.BLOCK_PORTAL_AMBIENT,
        ...
        for (int i = 0; i < 150; ++i) {
            ...
            Minecraft.getMinecraft().effectRenderer.addEffect(new ParticleTakumiPortal(worldIn, d0, d1, d2, d3, d4, d5));
        }
    }
    ...
    public PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_) {
        ...
        for (AxisDirection enumfacing$axisdirection : AxisDirection.values()) {
            PatternHelper blockpattern$patternhelper = new PatternHelper(enumfacing.getAxisDirection() == enumfacing$axisdirection ? blockpos :
                                                                         blockpos.offset(blockportal$size.rightDir, blockportal$size.getWidth() -
                                                                                 1), EnumFacing.getFacingFromAxis(enumfacing$axisdirection,
        ...
        return new PatternHelper(enumfacing.getAxisDirection() == enumfacing$axisdirection1 ? blockpos :
                                 blockpos.offset(blockportal$size.rightDir, blockportal$size.getWidth() - 1), EnumFacing.getFacingFromAxis
                (enumfacing$axisdirection1, enumfacing$axis), EnumFacing.UP, loadingcache, blockportal$size.getWidth(), blockportal$size.getHeight
                (), 1);
    }
    ...
    public static class Size {
        ...
        public Size(World worldIn, BlockPos p_i45694_2_, Axis p_i45694_3_) {
            ...
            for (BlockPos blockpos = p_i45694_2_; p_i45694_2_.getY() > blockpos.getY() - 21 && p_i45694_2_.getY() > 0 && this.isEmptyBlock(worldIn
                    .getBlockState(p_i45694_2_.down())); p_i45694_2_ = p_i45694_2_.down()) {
            }
        ...
        protected boolean isEmptyBlock(IBlockState state) {
            ...
            return state.getMaterial() == Material.AIR || blockIn == Blocks.FIRE || blockIn == TakumiBlockCore.TAKUMI_PORTAL;
        }
        ...
        protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
            ...
            for (i = 0; i < 22; ++i) {
                ...
                if (!this.isEmptyBlock(this.world.getBlockState(blockpos)) || this.world.getBlockState(blockpos.down()).getBlock() !=
        ...
        protected int calculatePortalHeight() {
            ...
            for (int j = 0; j < this.width; ++j) {
                if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != TakumiBlockCore
                        .TAKUMI_PORTAL_FRAME) {
                    this.height = 0;
                    break;
                }
        ...
        public void placePortalBlocks() {
            for (int i = 0; i < this.width; ++i) {
                ...
                for (int j = 0; j < this.height; ++j) {
                    this.world.setBlockState(blockpos.up(j), TakumiBlockCore.TAKUMI_PORTAL.getDefaultState().withProperty(AXIS, this.axis), 2);
                }
            }
        }
    }
