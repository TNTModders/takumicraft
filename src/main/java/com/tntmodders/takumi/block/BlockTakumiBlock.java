...
public class BlockTakumiBlock extends BlockContainer {
    ...
    private class WorldDummyTakumiBlock extends World {
        ...
        protected IChunkProvider createChunkProvider() {
            return FMLCommonHandler.instance().getSide().isClient() ? new ChunkProviderClient(this) :
                   new ChunkProviderServer(FMLCommonHandler.instance().getMinecraftServerInstance().getWorld(this.world.provider.getDimension()),
        ...
        public IBlockState getBlockState(BlockPos pos) {
            if (this.world.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) this.world.getTileEntity(pos)).getBlock
                    () != null) {
                if (((TileEntityTakumiBlock) this.world.getTileEntity(pos)).state == null) {
                    ((TileEntityTakumiBlock) this.world.getTileEntity(pos)).state = ((TileEntityTakumiBlock) this.world.getTileEntity(pos))
                            .getBlock().getActualState(((TileEntityTakumiBlock) this.world.getTileEntity(pos)).getBlock().getDefaultState(), this
                                    .world, pos);
                }
    ...
    public BlockFaceShape getBlockFaceShape(IBlockAccess world, IBlockState state, BlockPos pos, EnumFacing facing) {
        if (world.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock() != null) {
            return ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock().getBlockFaceShape(world, ((TileEntityTakumiBlock) world
                    .getTileEntity(pos)).state, pos, facing);
        }
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock() != null) {
            if (((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).state == null) {
                ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).state = ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock()
                        .getActualState(((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock().getDefaultState(), worldIn, pos);
            }
            ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock().randomDisplayTick(((TileEntityTakumiBlock) worldIn.getTileEntity(pos))
                    .state, worldIn, pos, rand);
        } else {
    ...
    public void neighborChanged(IBlockState stateIn, World world, BlockPos pos, Block blockIn, BlockPos neighbor) {
        if (world.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock() != null) {
            ...
            if (((TileEntityTakumiBlock) world.getTileEntity(pos)).state == null) {
                ((TileEntityTakumiBlock) world.getTileEntity(pos)).setState(((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock()
                        .getDefaultState().getActualState(world, pos));
            }
            ((TileEntityTakumiBlock) world.getTileEntity(pos)).state.neighborChanged(this.dummyWorld, pos, ((TileEntityTakumiBlock) world
                    .getTileEntity(pos)).getBlock(), pos);
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
        if (blockAccess.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) blockAccess.getTileEntity(pos)).getBlock()
                != null) {
            return ((TileEntityTakumiBlock) blockAccess.getTileEntity(pos)).getBlock().getWeakPower(blockState, blockAccess, pos, side);
        }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float
        ...
        if (playerIn.getHeldItem(hand).getItem() instanceof ItemBlock && playerIn.getHeldItem(hand).getItem() != Item.getItemFromBlock
                (TakumiBlockCore.TAKUMI_BLOCK)) {
    ...
    public Vec3d modifyAcceleration(World worldIn, BlockPos pos, Entity entityIn, Vec3d motion) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock() != null) {
            return ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock().modifyAcceleration(worldIn, pos, entityIn, motion);
        }
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock() != null) {
            ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock().onEntityCollidedWithBlock(worldIn, pos, state, entityIn);
        } else {
    ...
    public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock() != null) {
            ((TileEntityTakumiBlock) worldIn.getTileEntity(pos)).getBlock().onFallenUpon(worldIn, pos, entityIn, fallDistance);
        } else {
    ...
    public void onLanded(World worldIn, Entity entityIn) {
        if (worldIn.getTileEntity(entityIn.getPosition().down()) instanceof TileEntityTakumiBlock) {
            if (((TileEntityTakumiBlock) worldIn.getTileEntity(entityIn.getPosition().down())).getBlock() != null) {
                ((TileEntityTakumiBlock) worldIn.getTileEntity(entityIn.getPosition().down())).getBlock().onLanded(worldIn, entityIn);
            }
        } else {
    ...
    public float getSlipperiness(IBlockState state, IBlockAccess world, BlockPos pos, @Nullable Entity entity) {
        if (world.getTileEntity(pos) instanceof TileEntityTakumiBlock) {
            if (((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock() != null) {
                return ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock().getSlipperiness(state, world, pos, entity);
            }
        }
    ...
    public boolean canSustainPlant(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing direction, IPlantable plantable) {
        if (world.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock() != null) {
            return ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock().canSustainPlant(state, world, pos, direction, plantable);
        }
    ...
    public boolean shouldCheckWeakPower(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing side) {
        if (world.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock() != null) {
            return ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock().shouldCheckWeakPower(state, world, pos, side);
        }
    ...
    public SoundType getSoundType(IBlockState state, World world, BlockPos pos, @Nullable Entity entity) {
        if (world.getTileEntity(pos) instanceof TileEntityTakumiBlock && ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock() != null) {
            return ((TileEntityTakumiBlock) world.getTileEntity(pos)).getBlock().getSoundType(state, world, pos, entity);
        }
